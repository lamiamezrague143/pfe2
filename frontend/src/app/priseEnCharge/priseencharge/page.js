...
import DossierModal from "../../../components/DossierModal";// ─── NOTIFICATION SYSTEM ─────────────────────────────────────────────────────
...
<DossierModal
  ...
  onPrefillForm={prefillFromDemande} 
    onDownloadPEC={(item) => downloadPEC(item, cliniques)}  // ← ajouter  // ← ajouter
/>
      )}
      {showPrixModal && (
