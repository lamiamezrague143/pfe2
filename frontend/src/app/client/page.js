        ...
        {activeTab === "profil" && (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="px-8 py-6">
              ...
              {[
  { label: "Nom complet", value: userData?.nomComplet || "—" },
  { label: "Fonction", value: userData?.positionAdministrative || "—" },
  { label: "Téléphone", value: userData?.numero || "—" },
  { label: "Date de naissance", value: userData?.dateNaissance || "—" },
].map(({ label, value }) => (
