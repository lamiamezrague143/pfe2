...
const menuItems = [
  { icon: HomeIcon, label: "Accueil", href: "/priseEnCharge" },
  { icon: FolderIcon, label: "Prise en Charge", href: "/priseEnCharge/priseencharge" },
  { icon: UserPlusIcon, label: "Ajout Enseignant", href: "/priseEnCharge/AjoutEns" },
  { icon: BuildingOfficeIcon, label: "Ajout Etablissement", href: "/priseEnCharge/AjoutEtab" },
    ...
    <aside className="relative bg-white shadow-2xl shadow-slate-200 w-64 flex flex-col min-h-screen"
      ...
      <div className="p-5 border-b border-slate-100 flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-[8px] text-slate-400 uppercase tracking-wider font-semibold">Prise en Charge</p>
        </div>
      </div>
      ...
      <div className="mx-4 mt-6 p-3 rounded-xl bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <p className="text-xs font-bold text-slate-700">Agent COS</p>
            <p className="text-[9px] text-slate-500">Prise en Charge</p>
          </div>
        </div>
      </div>
